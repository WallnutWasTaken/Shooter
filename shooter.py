...
#Fonts
font.init()
font2 = font.SysFont("Comic Sans MS",48)
win = font2.render("You Win! :D Big W to you!",True,(255,255,0))
lose = font2.render("you lose :( big L to you",True,(255,0,0))
    ...
    if not finish:
        ...
        if rel_time == True:
            ...
            if now_time - last_time < 1:
                rel_text = font2.render("Reloading...",1,(150,0,0))
                window.blit(rel_text,(260,460))
            else:
                num_fire = 0
                rel_time = False
        
        #Collisions of Bullets and Ufo
